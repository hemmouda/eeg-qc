...
from _07_full_dt_hyperparams import OUTPUT
...
OUTPUT_DIR = Path("_08_full_dt_hyperparams_figures")
...
def plot_target(target: str, results: dict):
    ...
    out = OUTPUT_DIR / f"{target}_full_dt_depth_f1.png"
